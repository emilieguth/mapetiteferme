...
class ToolModel extends \ModuleModel {
	...
	protected string $module = 'company\Tool';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'action' => ['element32', 'company\Action', 'null' => TRUE, 'cast' => 'element'],
			...
			'status' => ['enum', [\company\Tool::ACTIVE, \company\Tool::INACTIVE], 'cast' => 'enum'],
