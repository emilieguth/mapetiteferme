...
class ActionModel extends \ModuleModel {
	...
	protected string $module = 'company\Action';
	...
	public function __construct() {
		...
		$this->properties = array_merge($this->properties, [
			...
			'farm' => ['element32', 'company\Company', 'null' => TRUE, 'cast' => 'element'],
			'color' => ['color', 'cast' => 'string'],
			'pace' => ['enum', [\company\Action::BY_HARVEST, \company\Action::BY_AREA, \company\Action::BY_PLANT], 'null' => TRUE, 'cast' => 'enum'],
