...
class SupplierLib extends SupplierCrud {
	...
	public static function getFromQuery(string $query, \company\Company $eFarm, ?array $properties = []): \Collection {
	...
	public static function getByFarm(\company\Company $eFarm, \Search $search = new \Search()): \Collection {
