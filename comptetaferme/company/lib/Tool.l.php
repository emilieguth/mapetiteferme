...
class ToolLib extends ToolCrud {
	...
	public static function countByFarm(\company\Company $eFarm, ?string $routineName): array {
	...
	public static function getFromQuery(string $query, \company\Company $eFarm, Action $eAction, ?array $properties = []): \Collection {
	...
	public static function getOneByFarm(\company\Company $eFarm, mixed $id): Tool {
	...
	public static function getByFarm(\company\Company $eFarm, mixed $id = NULL, ?string $routineName = NULL, \Search $search = new \Search()): \Collection|\Element {
	...
	public static function getForWork(\company\Company $eFarm, Action $eAction): \Collection {
	...
	public static function getActionsByFarm(\company\Company $eFarm): \Collection {
