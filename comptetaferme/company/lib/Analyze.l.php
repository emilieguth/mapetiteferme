...
class AnalyzeLib {
	...
	public static function getActionMonths(\company\Action $eAction, Category $eCategory, int $year): array {
	...
	public static function getActionTimesheet(\company\Action $eAction, Category $eCategory, int $year): \Collection {
