...
class CategoryLib extends CategoryCrud {
	...
	public static function getByFarm(\company\Company $eFarm, mixed $id = NULL, array|string|null $fqn = NULL, string $index = NULL): \Collection|Category {
	...
	public static function create(Category $e): void {
		...
		if($categories === \Setting::get('company\categoriesLimit')) {
	...
	public static function reorder(\company\Company $eFarm): void {
