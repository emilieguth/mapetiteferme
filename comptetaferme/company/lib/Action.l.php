...
class ActionLib extends ActionCrud {
	...
	public static function duplicateForFarm(\company\Company $eFarm): \Collection {
	...
	public static function getByFarm(\company\Company $eFarm, mixed $id = NULL, array|string|null $fqn = NULL, Category|string $category = new Category(), string $index = NULL): \Collection|Action {
	...
	public static function getMainByFarm(Farm $eFarm): \Collection {
		...
		try {
			return \Setting::get('company\mainActions');
		}
		catch(\Exception) {
			...
			\Setting::set('company\mainActions', $cAction);
	...
	public static function getForManage(\company\Company $eFarm): \Collection|Action {
	...
	public static function getByFarmWithPace(\company\Company $eFarm): \Collection|Action {
	...
	public static function canUse(Action $eAction, \company\Company $eFarm): bool {
