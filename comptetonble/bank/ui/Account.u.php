...
class AccountUi {
	...
	public function list(\company\Company $eCompany ,\Collection $cAccount): string {
		...
		$h .= '<div class="util-warning">'.s("Attention, en <b>modifiant le libellé d'un compte bancaire</b>, toutes les écritures comptables de l'exercice fiscal en cours qui sont liées à ce compte bancaire verront leur n° de compte être mis à jour en correspondance.").'</div>';
