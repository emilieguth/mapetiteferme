...
class LegalUi {
	...
	public function tos() : string {
		...
		$h .= '<p><a href="https://github.com/vingtcent123/comptetonble" class="btn btn-outline-primary">'.s("Voir le dépôt du code source").'</a></p>';
	...
	public function faq() : string {
		...
		$h .= '<div class="home-category">';
			...
			$h .= '<ul>';
				$h .= '<li>'.s("Un blog pour suivre l'actualité du site").'<br/><a href="https://blog.comptetonble.fr/" class="btn btn-secondary mb-1">'.s("Voir le blog").'</a></li>';
				$h .= '<li>'.s("Un site de démo pour voir comment est utilisée la plateforme par la ferme à l'origine de {siteName} et dont les données ont été anonymisées").'<br/><a href="https://demo.comptetonble.fr/" class="btn btn-secondary mb-1">'.s("Voir la démo").'</a></li>';
				$h .= '<li>'.s("Un salon de discussion ouvert à tous").'<br/><a href="https://app.element.io/#/room/#comptetonble:matrix.org" class="btn btn-secondary mb-1">'.s("Voir le salon de discussion").'</a></li>';
		...
		$h .= '<div class="home-category">';
			...
			$h .= '<p><a href="https://blog.comptetonble.fr/feuille-de-route" class="btn btn-secondary mb-1">'.s("Voir la feuille de route").'</a></p>';
